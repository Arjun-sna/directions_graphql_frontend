...
export default ({
  ...
  <div>
    ...
    <div className={styles['route-detail-section']}>
      ...
      <div className={styles['route-details-container']}>
        <div>
          <span className={`${styles['highlight']} ${styles['start']}`}>From</span>
          <span className={styles['detail-text']}>{ data.tripData.departure.address }</span>
        </div>
        <div>
        <span className={`${styles['highlight']} ${styles['end']}`}>To</span>
        <span className={styles['detail-text']}>{ data.tripData.arrival.address }</span>
        </div>
        <div>
          <span className={styles['highlight']}>Duration</span>
          <span className={styles['detail-text']}>{ data.tripData.tripDuration.formattedValue }</span>
        </div>
        <div>
          <span className={styles['highlight']}>Distance</span>
          <span className={styles['detail-text']}>{ data.tripData.tripDistance.formattedValue }</span>
        </div>
      </div>
    </div>
    <div className={styles['route-detail-section']}>
